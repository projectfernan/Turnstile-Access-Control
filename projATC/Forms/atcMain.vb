...
Public Class atcMain
    ...
    Private Delegate Sub LoadController()
    ...
    Sub loadContollers()
        If (InvokeRequired) Then
            Invoke(New LoadController(AddressOf loadContollers))
        Else
    ...
    Private Sub atcMain_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        ...
        'Dim th As New Thread(New ThreadStart(Sub() LoadDevList()))
        'th.Start()
        Dim th As New Thread(New ThreadStart(Sub() loadContollers()))
        th.Start()
