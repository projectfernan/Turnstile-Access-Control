Public Class frmLogsHistory
    ...
    Private Sub cmdSubmit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSubmit.Click
        If MsgBox("Are you sure do you want to clear all logs history?    ", vbQuestion + vbYesNo + vbDefaultButton2, "Clear logs history") = vbYes Then
            del()
            LstDept.Clear()
            header()
            fill()
    ...
    Sub del()
        Dim rs As New Recordset
        rs = New Recordset
        rs = conSql.Execute("Delete from tblAccHistory")
    End Sub
End Class