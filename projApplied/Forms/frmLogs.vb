...
Public Class frmLogs
    ...
    Sub Extall()
        ...
        Dim lup As Short
        rsPRS = New Recordset
        rsPRS = conSql.Execute("select * from tblTImeOut")
        If rsPRS.EOF = False Then
            For lup = 1 To rsPRS.RecordCount
                LstEmpRec.Refresh()
                Dim viewlst As New ListViewItem
                ...
                viewlst.SubItems.Add(rsPRS("IDnumber").Value)
                viewlst.SubItems.Add(rsPRS("Name").Value)
                viewlst.SubItems.Add(rsPRS("TimeOut").Value)
                rsPRS.MoveNext()
            Next
        End If
    End Sub
    ...
    Sub EntSrch()
        ...
        'Dim rs As New Recordset
        rsPRS = New Recordset
        rsPRS = conSql.Execute("select * from tblTImein where Name like '" & txtInput.Text & "%' and TimeIn >= '" & TmeInFrm & "' and TimeIn <='" & TmeInTo & "'")
        If rsPRS.EOF = False Then
            ProgBar.Value = 0
    ...
    Sub InOutSrch()
        ...
        'Dim rs As New Recordset
        rsIO = New Recordset
        rsIO = conSql.Execute("select * from tblInOut where Name like '" & txtInput.Text & "%' and TimeOut >= '" & TmeInFrm & "' and TimeOut <= '" & TmeInTo & "'")
