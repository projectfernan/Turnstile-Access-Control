Public Class frmAddList
    ...
    Sub fill()
        ...
        Dim lup As Short
        rs = New Recordset
        rs = PathConn.Execute("select BADGENUMBER,SSN,Name,Title,Gender,Pager,Street,BirthDay from USERINFO order by USERID")
        If rs.EOF = False Then
            ...
            For lup = 1 To rs.RecordCount
                ...
                LstEmpRec.Refresh()
                rs2 = New Recordset
                rs2 = conSql.Execute("select ACnumber from tblstudinfo where ACnumber = '" & rs("BADGENUMBER").Value & "' limit 1;")
    ...
    Sub Findfill()
        ...
        Dim lup As Short
        rs = New Recordset
        rs = PathConn.Execute("select BADGENUMBER,SSN,Name,Title,Gender,Pager,Street,BirthDay from USERINFO where " & cboCateg.Text & " like '" & txtInput.Text & "%'")
        If rs.EOF = False Then
            Progbar.Maximum = rs.RecordCount
            For lup = 1 To rs.RecordCount
                LstEmpRec.Refresh()
