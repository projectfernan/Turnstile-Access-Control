Public Class frmPicPath
    ...
    Private Sub cmdBrowse_Click_1(sender As System.Object, e As System.EventArgs) Handles cmdBrowse.Click
        browse()
        If txtpath.Text = vbNullString Then
            Exit Sub
        End If
    ...
    Private Sub cmdSubmit_Click_1(sender As System.Object, e As System.EventArgs) Handles cmdSubmit.Click
        With My.Settings
            .PicPath = txtpath.Text
            .Save()
        End With
