...
Public Class crtAttReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrjTurnstile.crtAttReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtAttReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtAttReport = New crtAttReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
