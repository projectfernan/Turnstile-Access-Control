...
Public Class crtEmpTImeIn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrjTurnstile.crtEmpTImeIn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtEmpTImeIn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtEmpTImeIn = New crtEmpTImeIn()
        rpt.Site = Me.Site
        Return rpt
    End Function
