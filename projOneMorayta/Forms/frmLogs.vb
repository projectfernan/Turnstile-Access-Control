...
Public Class frmLogs
    ...
    Sub EntHead()
        ...
        LstEmpRec.Columns.Add("Remarks", 170, HorizontalAlignment.Left)
    End Sub
    ...
    Sub AttHead()
        ...
        LstEmpRec.Columns.Add("InRemarks", 170, HorizontalAlignment.Left)
        LstEmpRec.Columns.Add("TimeOut", 180, HorizontalAlignment.Left)
        LstEmpRec.Columns.Add("OutRemarks", 170, HorizontalAlignment.Left)
        LstEmpRec.Columns.Add("Lane", 170, HorizontalAlignment.Left)
    ...
    Sub EntSrch()
        ...
        If rsPRS.EOF = False Then
            ...
            For lup = 1 To rsPRS.RecordCount
                ...
                viewlst.SubItems.Add(rsPRS("Remarks").Value)
                rsPRS.MoveNext()
                ProgBar.Value = lup
            Next
        End If
    ...
    Sub ExtSrch()
        ...
        If rsOut.EOF = False Then
            ...
            For lup = 1 To rsOut.RecordCount
                ...
                viewlst.SubItems.Add(rsOut("Remarks").Value)
                rsOut.MoveNext()
                ProgBar.Value = lup
            Next
        End If
    ...
    Sub InOutSrch()
        ...
        If rsIO.EOF = False Then
            ...
            For lup = 1 To rsIO.RecordCount
                ...
                viewlst.SubItems.Add(rsIO("InRemarks").Value)
                viewlst.SubItems.Add(rsIO("TimeOut").Value)
                viewlst.SubItems.Add(rsIO("OutRemarks").Value)
