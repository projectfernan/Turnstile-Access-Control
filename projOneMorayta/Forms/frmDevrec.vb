Public Class frmDevrec
    ...
    Sub header()
        ...
        lstList.Columns.Add("Lane", 180, HorizontalAlignment.Left)
        lstList.Columns.Add("Status", 180, HorizontalAlignment.Left)
        lstList.Columns.Add("Delay", 180, HorizontalAlignment.Left)
        lstList.Columns.Add("Startup", 130, HorizontalAlignment.Left)
    End Sub
    ...
    Private Sub frmDevrec_Shown(sender As Object, e As System.EventArgs) Handles Me.Shown
        ...
        With My.Settings
            ...
            chkAutoConn.Checked = .AutoDevConn
    ...
    Private Sub chkAutoConn_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkAutoConn.CheckedChanged
        My.Settings.AutoDevConn = chkAutoConn.Checked
        My.Settings.Save()
    End Sub
End Class