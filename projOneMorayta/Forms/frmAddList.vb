Public Class frmAddList
    ...
    Sub header()
        ...
        LstEmpRec.Columns.Add("CardNo", 200, HorizontalAlignment.Left)
    ...
    Sub fill()
        ...
        Dim lup As Short
        rs = New Recordset
        rs = PathConn.Execute("select BADGENUMBER,CardNo,Name,Title,Gender,Pager,Street,Birthday from USERINFO order by USERID")
        If rs.EOF = False Then
            ...
            For lup = 1 To rs.RecordCount
                ...
                If rs2.EOF = True Then
                    ...
                    Try
                        viewlst.SubItems.Add(rs("CardNo").Value)
        ...
        If rs.EOF = False Then
            ...
            Do While rs.EOF = False
                ...
                If rs2.EOF = True Then
                    ...
                    rs3("IDnumber").Value = rs("CardNo").Value
                    ...
                    rs3("RoomName").Value = "NA"
                    rs3("BedNumber").Value = "NA"
                    rs3("AccessGroup").Value = "NA"
                    rs3("ExpiredDate").Value = Now
                    rs3("AccessStatus").Value = 1
    ...
    Sub Findfill()
        ...
        Dim lup As Short
        rs = New Recordset
        rs = PathConn.Execute("select BADGENUMBER,CardNo,Name,Title,Gender,Pager,Street,Birthday from USERINFO where " & cboCateg.Text & " like '" & txtInput.Text & "%'")
        If rs.EOF = False Then
            Progbar.Value = 0
            Progbar.Maximum = rs.RecordCount
            For lup = 1 To rs.RecordCount
        ...
        For Each viewlst In LstEmpRec.Items
            If viewlst.Selected = True Then
                ...
                With frmAddCard
                    ...
                    .dtExpiredDate.Value = viewlst.SubItems(8).Text
