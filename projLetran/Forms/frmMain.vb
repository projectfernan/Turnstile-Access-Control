...
Public Class frmMain
    ...
    Function verNull() As Boolean
        If frmConDev.T1DevIp1.Text = vbNullString Or frmConDev.T1DevIp2.Text = vbNullString Or frmConDev.T2DevIp1.Text = vbNullString Or frmConDev.T2DevIp2.Text = vbNullString Or frmConDev.T3DevIp1.Text = vbNullString Or frmConDev.T3DevIp2.Text = vbNullString Then
            Return True
        Else
            Return False
        End If
