...
Public Class frmLogs
        ...
        Try
            ...
            If rsIn.EOF = False Then
                For lup = 1 To rsIn.RecordCount
                    ...
                    viewlst.SubItems.Add(rsIn("FolderName").Value)
        ...
        Try
            ...
            If rsInOut.EOF = False Then
                For lup = 1 To rsInOut.RecordCount
                    ...
                    viewlst.SubItems.Add(rsInOut("FolderName").Value)
    ...
    Private Sub cboCateg_SelectedIndexChanged_1(ByVal sender As System.Object, ByVal e As System.EventArgs)
                LstEmpRec.Clear()
                EntHead()
                able()
                cmdDel.Enabled = False
        ...
        For Each viewlst In LstEmpRec.Items
            If viewlst.Selected = True Then
                Try
                    ...
                    EmpPic.Image = StudentPic(viewlst.SubItems(1).Text & "p")
