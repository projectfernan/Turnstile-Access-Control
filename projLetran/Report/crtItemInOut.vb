...
Public Class crtItemInOut
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrjTurnstile.crtItemInOut.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtItemInOut
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtItemInOut = New crtItemInOut()
        rpt.Site = Me.Site
        Return rpt
    End Function
